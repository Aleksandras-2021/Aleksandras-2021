...
|--------|-------------|-------|------|
| [Vurello](https://github.com/Aleksandras-2021/Vurello) | Trello-inspired task management app with CI/CD and self-hosted deployment | ASP.NET Core, React, PostgreSQL, Docker, AWS EC2 | [vurello.click](https://vurello.click) |
| [Quortle](https://github.com/Aleksandras-2021/Quortle) | Daily 4-letter Wordle variant | Go, Docker, AWS EC2 | [quortle.eu](https://quortle.eu) |
